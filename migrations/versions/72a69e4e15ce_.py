...
Revision ID: 72a69e4e15ce
Revises: 62afa56511c0
Create Date: 2020-06-02 16:06:56.765356
...
revision = '72a69e4e15ce'
down_revision = '62afa56511c0'
branch_labels = None
depends_on = None
...
def upgrade_cpstnpro():
    ...
    op.add_column('items', sa.Column('cost', sa.DECIMAL(precision=10, scale=2), nullable=True))
