"""fix error with missing enum name

Revision ID: ec529c926c8b
Revises: a632176ae5e5
Create Date: 2020-04-10 21:51:25.707488
...
revision = 'ec529c926c8b'
down_revision = 'a632176ae5e5'
branch_labels = None
depends_on = None
