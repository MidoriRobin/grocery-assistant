...
Revision ID: 37de9b1ed7c3
Revises: a74966cc848e
Create Date: 2020-06-12 16:46:10.639684
...
revision = '37de9b1ed7c3'
down_revision = 'a74966cc848e'
branch_labels = None
depends_on = None
...
def upgrade_cpstnpro():
    ...
    sa.Column('desc_item', sa.String(length=255), nullable=True),
    ...
    sa.Column('date_created', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['acc_num'], ['usr.acc_num'], ),
    sa.PrimaryKeyConstraint('list_id', 'acc_num')
    )
    op.create_index(op.f('ix_shopping_list_acc_num'), 'shopping_list', ['acc_num'], unique=False)
    op.create_index(op.f('ix_shopping_list_list_id'), 'shopping_list', ['list_id'], unique=False)
...
def downgrade_cpstnpro():
    ...
    op.drop_index(op.f('ix_shopping_list_list_id'), table_name='shopping_list')
