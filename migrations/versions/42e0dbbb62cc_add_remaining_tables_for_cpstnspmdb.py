"""Add remaining tables for cpstnspmdb

Revision ID: 42e0dbbb62cc
Revises: 34a0b698d225
Create Date: 2020-04-10 17:13:30.566934
...
revision = '42e0dbbb62cc'
down_revision = '34a0b698d225'
branch_labels = None
depends_on = None
...
def upgrade_cpstnpro():
    ...
    sa.Column('spm_id', sa.String(length=10), nullable=False),
    ...
    op.create_index(op.f('ix_supermarket_spm_name'), 'supermarket', ['spm_name'], unique=False)
    op.create_table('usr',
    sa.Column('acc_num', sa.String(length=20), nullable=False),
    ...
    sa.Column('hh_size', sa.Integer(), nullable=True),
    sa.Column('no_adults', sa.Integer(), nullable=True),
    sa.Column('no_kids', sa.Integer(), nullable=True),
    sa.Column('marital_s', sa.CHAR(length=1), nullable=True),
    sa.Column('diet_pref', sa.String(length=20), nullable=True),
    sa.PrimaryKeyConstraint('acc_num')
    )
    op.create_table('courier',
    sa.Column('cour_id', sa.String(length=10), nullable=False),
    ...
    op.create_index(op.f('ix_courier_spm_name'), 'courier', ['spm_name'], unique=False)
    ...
    sa.Column('acc_num', sa.String(length=20), nullable=True),
    sa.Column('spm_id', sa.String(length=10), nullable=True),
    sa.ForeignKeyConstraint(['acc_num'], ['usr.acc_num'], ),
    sa.ForeignKeyConstraint(['spm_id'], ['supermarket.spm_id'], ),
    sa.PrimaryKeyConstraint('item_id')
    )
    op.create_index(op.f('ix_items_acc_num'), 'items', ['acc_num'], unique=False)
    ...
    sa.Column('pay_id', sa.String(length=10), nullable=False),
    ...
    sa.Column('acc_num', sa.String(length=20), nullable=False),
    sa.Column('item_id', sa.String(length=20), nullable=False),
    sa.Column('ratings', sa.Enum('1', '2', '3', '4', '5'), nullable=True),
    sa.ForeignKeyConstraint(['acc_num'], ['usr.acc_num'], ),
    ...
    sa.Column('list_id', sa.String(length=20), nullable=False),
...
def downgrade_cpstnpro():
    ...
    op.drop_index(op.f('ix_items_acc_num'), table_name='items')
    op.drop_table('items')
